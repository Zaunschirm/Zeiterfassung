...
(function(){
  ...
  const UI = { backdrop:$id('empDrawerBackdrop'), drawer:$id('empDrawer'), title:$id('drawerTitle'),
    closeBtn:$id('drawerClose'), cancelBtn:$id('drawerCancel'), addBtn:$id('addEmp'), saveBtn:$id('saveEmp'),
    name:$id('empName'), user:$id('empUser'), role:$id('empRole'), pw:$id('empPw'), photo:$id('empPhoto'),
